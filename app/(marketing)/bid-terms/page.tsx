...
export default function BidTermsPage() {
  return (
    <div className="bg-zinc-50 font-sans text-secondary">
      <section className="relative overflow-hidden border-b border-zinc-100 bg-white px-6 py-10 text-center italic md:py-12">
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <h1 className="mb-4 font-display text-4xl font-black uppercase leading-none tracking-tighter md:text-5xl">
      ...
      <section className="px-6 py-10 md:py-12">
        <div className="mx-auto max-w-4xl space-y-4">
          {terms.map((term) => (
            <article key={term.number} className="flex gap-4 rounded-[28px] border border-zinc-100 bg-white p-5 shadow-sm md:p-6">
          ...
          <article className="rounded-[28px] border border-secondary/10 bg-secondary p-5 text-white shadow-xl md:p-6">
            ...
            <ul className="mt-4 list-disc space-y-1.5 pl-5 text-sm font-medium leading-relaxed text-white/70">
      ...
      <section className="border-t border-zinc-100 bg-white px-6 py-10 text-center italic md:py-12">
        <h2 className="mb-4 font-display text-2xl font-bold uppercase">Ready to bid?</h2>
        <Link href="/auctions" className="inline-flex items-center gap-3 rounded-2xl bg-primary px-8 py-4 text-[11px] font-bold uppercase tracking-widest text-white shadow-xl shadow-primary/20 transition-all hover:bg-secondary">

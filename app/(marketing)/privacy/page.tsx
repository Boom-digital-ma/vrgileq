      ...
      <section className="px-6 py-10 md:py-12">
        <div className="max-w-5xl mx-auto">
            <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {principles.map((p, i) => (
                    <div key={i} className="rounded-[24px] border border-zinc-100 bg-white p-5 shadow-sm transition-all hover:shadow-xl hover:shadow-secondary/5">
            ...
            <div className="space-y-6 rounded-[32px] border border-zinc-100 bg-white p-6 text-[11px] font-medium leading-relaxed text-zinc-500 uppercase italic shadow-sm md:p-9">
                
                <div className="space-y-3">
                    <h2 className="border-b border-zinc-50 pb-3 text-sm font-black uppercase text-secondary">Privacy Policy</h2>
                ...
                <div className="space-y-3">
                    <h2 className="border-b border-zinc-50 pb-3 text-sm font-black uppercase text-secondary">1. Definitions</h2>
                ...
                <div className="space-y-3">
                    <h2 className="border-b border-zinc-50 pb-3 text-sm font-black uppercase text-secondary">2. Information We Collect</h2>
                    <div className="space-y-3">
                        ...
                        <h3 className="mt-5 font-bold text-primary">2.2 Usage Data</h3>
                        ...
                        <h3 className="mt-5 font-bold text-primary">2.3 Location Data</h3>
                        ...
                        <h3 className="mt-5 font-bold text-primary">2.4 Cookies and Similar Technologies</h3>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-5 pt-4 text-[10px] md:grid-cols-3">
